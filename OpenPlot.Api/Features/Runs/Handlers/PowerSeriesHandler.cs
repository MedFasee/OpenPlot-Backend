...
/// <summary>
/// Handler para c�lculo de pot�ncia ativa/reativa.
/// Recebe V/I em phasores (MAG+ANG) e calcula P/Q por fase ou total.
/// Responsabilidade: valida��o, SQL, c�lculo de pot�ncia e resposta.
/// </summary>
public sealed class PowerSeriesHandler
{
    ...
    /// <summary>
    /// Processa requisi��o de pot�ncia ativa/reativa.
    /// </summary>
...
";
        ...
        if (seriesOut.Count == 0)
            return Results.BadRequest("Nenhuma PMU p�de ser processada (faltam sinais MAG/ANG de V/I ou alinhamento falhou).");
