# Features do OpenPlot.Api

## Visão Geral

Esta pasta reúne a documentação técnica das features expostas pelo projeto `OpenPlot.Api`.
...
- [`postProcessingEndpoints.md`](postProcessingEndpoints.md) — pós-processamento baseado em `cache_id`.
...
- dependências e observações de implementação.
